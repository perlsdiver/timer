...
- **AI Disclosure:** [AI Use Disclosure Guide](https://crln.acrl.org/index.php/crlnews/article/view/26548/34482)
- **Features:** [Pomofocus.io](https://pomofocus.io/)
- **Audio:** [HerbertBoland](https://freesound.org/people/HerbertBoland/sounds/30153/)
- **Images:** [PlaceCats.com](https://placecats.com/) and [Picsum Photos](https://picsum.photos/).

## Project Evolution (Changelog)

- **March 13, 2026:** Rebranded to **Frankentimer**. Integrated the AI Use Disclosure Framework. Migrated to Astro while preserving the Vanilla version. Unified UI link styles and expanded theme cursors.
